  ...
  <svg {{ $attributes }}>
    <g data-name="Group 107">
      <path data-name="Path 574"
        ...
        fill="#3f3d56"></path>
      <circle data-name="Ellipse 129" cx="1.29" cy="1.29" r="1.29" transform="translate(45.687 26.087)"
        fill="#d0cde1"></circle>
      <circle data-name="Ellipse 130" cx="1.29" cy="1.29" r="1.29" transform="translate(28.205 103.323)"
        fill="#d0cde1"></circle>
      <circle data-name="Ellipse 131" cx="0.573" cy="0.573" r="0.573" transform="translate(48.696 45.719)"
        fill="#d0cde1"></circle>
      <circle data-name="Ellipse 132" cx="0.573" cy="0.573" r="0.573" transform="translate(18.604 75.524)"
        fill="#d0cde1"></circle>
      <circle data-name="Ellipse 133" cx="0.573" cy="0.573" r="0.573" transform="translate(93.977 97.018)"
        fill="#d0cde1"></circle>
      <circle data-name="Ellipse 134" cx="0.573" cy="0.573" r="0.573" transform="translate(16.741 46.292)"
        fill="#d0cde1"></circle>
      <path data-name="Path 575" d="M52.134 31.676h-.287v-.287h-.143v.287h-.287v.143h.287v.287h.143v-.287h.287z"
        fill="#d0cde1">
      </path>
      <path data-name="Path 576" d="M30.21 36.405h-.287v-.287h-.143v.287h-.287v.143h.287v.287h.143v-.287h.287z"
        fill="#d0cde1">
      </path>
      <path data-name="Path 577" d="M15.881 63.345h-.282v-.287h-.143v.287h-.287v.143h.287v.287h.143v-.287h.287z"
        fill="#d0cde1">
      </path>
      <circle data-name="Ellipse 135" cx="0.573" cy="0.573" r="0.573" transform="translate(55.574 109.342)"
        fill="#d0cde1"></circle>
      <circle data-name="Ellipse 136" cx="0.573" cy="0.573" r="0.573" transform="translate(53.711 80.11)"
        fill="#d0cde1"></circle>
      <circle data-name="Ellipse 137" cx="0.573" cy="0.573" r="0.573" transform="translate(121.49 90.714)"
        fill="#d0cde1"></circle>
      <path data-name="Path 578" d="M52.851 97.162h-.287v-.287h-.143v.287h-.287v.143h.287v.287h.143v-.287h.287z"
        fill="#d0cde1">
      </path>
      <path data-name="Path 579" d="M80.65 107.336h-.286v-.286h-.143v.286h-.287v.143h.287v.287h.143v-.287h.286z"
        fill="#d0cde1">
      </path>
      <path data-name="Path 580" d="M10.434 81.83h-.287v-.287h-.143v.287h-.287v.143h.287v.286h.143v-.286h.287z"
        fill="#d0cde1">
      </path>
      <path data-name="Path 581" d="M50.272 61.195h-.287v-.287h-.143v.287h-.284v.143h.287v.287h.143v-.287h.287z"
        fill="#d0cde1">
      </path>
      <path data-name="Path 582" d="M32.646 44.286h-.287v-.287h-.143v.287h-.287v.143h.287v.287h.143v-.287h.287z"
        fill="#d0cde1">
      </path>
      <path data-name="Path 583" d="M44.401 72.515h-.287v-.287h-.143v.287h-.287v.143h.287v.287h.143v-.287h.287z"
        fill="#d0cde1">
      </path>
      <path data-name="Path 584" d="M27.201 90.284h-.287v-.287h-.143v.287h-.287v.143h.287v.287h.143v-.287h.287z"
        fill="#d0cde1">
      </path>
      <ellipse data-name="Ellipse 138" cx="8.454" cy="1.29" rx="8.454" ry="1.29"
        transform="translate(24.622 63.487)" fill="#6c63ff"></ellipse>
      ...
      <path data-name="Path 593"
        ...
        fill="#2f2e41"></path>
      <circle data-name="Ellipse 139" cx="5.6" cy="5.6" r="5.6"
        transform="translate(125.039 3.003)" fill="#ffb9b9"></circle>
      <path data-name="Path 594"
        d="M129.161 12.57s1.711 4.978 1.556 5.911 4.978-1.867 4.978-1.867-2.022-4.978-1.4-6.378z" fill="#ffb9b9">
      </path>
      ...
      <path data-name="Path 596"
        d="M132.428 18.947l-10.111 10.577L107.54 41.19l3.267 2.644 27.221-18.2s2.333-9.954-5.6-6.687z" fill="#d0cde1">
      </path>
