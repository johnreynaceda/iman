    ...
    public function run(): void
    {
        $assets = [
            [
                ...
                'description' =>
                    '1 Set CAMERA NIKON D5600 W/MEMORY CARD & CAMERA BAG',
                'price' => '36970',
                'remarks' => 1,
            ...
            [
                ...
                'description' =>
                    '1 Set WHITE EPSON LCD PROJECTOR  W/REMOTE CONTROL & BAG. EB-S41 MODELH842C W/REMOTE 218178800 & BLACK BAG',
                'price' => '21990',
                'remarks' => 1,
            ...
            [
                'name' => 'EPSON LCD PROJECTOR',
                'description' =>
                    '1 Set WHITE EPSON LCD PROJECTOR  W/REMOTE CONTROL & BAG',
                'price' => '21990',
                'remarks' => 1,
            ...
            [
                ...
                'description' =>
                    '1 SET COMPUTER DISKTOP PHILIPS W/LCD MONITOR,CPU EXTREME POWER CASE & AVR  INCLUSIVE MOUSE PAD ,KEYBOARD , 1  PAIR SPEAKER MOUSE',
                'price' => '21210',
                'remarks' => 1,
                'serial_number' =>
                    'ZVOA19007006639 (LCDMONITOR) CPU 0338449 CONTROL #12456',
                'category_id' => 4,
            ],
            [
                'name' => 'PROJECTOR',
                'description' =>
                    '1 SET EPSON LCD PROJECTOR W/B.BAG &COMPLETE CORD&REMOTE(IMAN-001 OLD FILE',
                'remarks' => 1,
